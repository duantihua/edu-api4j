...
public class ExecutionPlanCourseModify extends LongIdObject {
  ...
  private ExecutionPlanCourseModifyDetailBefore oldPlanCourse;

  /** 更改后的状态 */
  @OneToOne(optional = true, cascade = { CascadeType.ALL }, orphanRemoval = true)
  private ExecutionPlanCourseModifyDetailAfter newPlanCourse;
  ...
  public ExecutionPlanCourseModifyDetailBefore getOldPlanCourse() {
    return oldPlanCourse;
  }

  public void setOldPlanCourse(ExecutionPlanCourseModifyDetailBefore oldPlanCourse) {
    this.oldPlanCourse = oldPlanCourse;
  }

  public ExecutionPlanCourseModifyDetailAfter getNewPlanCourse() {
    return newPlanCourse;
  }

  public void setNewPlanCourse(ExecutionPlanCourseModifyDetailAfter newPlanCourse) {
