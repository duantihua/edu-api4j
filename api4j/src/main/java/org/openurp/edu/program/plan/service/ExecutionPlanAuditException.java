...
public class ExecutionPlanAuditException extends Exception {
  ...
  public ExecutionPlanAuditException(String message, Throwable cause) {
    super(message, cause);
  }

  public ExecutionPlanAuditException(String message) {
    super(message);
  }

  public ExecutionPlanAuditException(Throwable cause) {
    super(cause);
  }
