...
public class ClazzFilterByStdTypeStrategy extends AbstractClazzFilterStrategy
    implements ClazzFilterStrategy {

  public ClazzFilterByStdTypeStrategy() {
    super("stdType");
  }

  public String getFilterString() {
    return " where clazz.enrollment.stdType.id= :id ";
  }
}
