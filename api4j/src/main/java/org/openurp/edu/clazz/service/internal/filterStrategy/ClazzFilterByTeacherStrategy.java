...
public class ClazzFilterByTeacherStrategy extends AbstractClazzFilterStrategy
    implements ClazzFilterStrategy {

  public ClazzFilterByTeacherStrategy() {
    super("teacher");
  }

  public String getFilterString() {
    return " join clazz.teachers as teacher where teacher.id = :id ";
  }
}
