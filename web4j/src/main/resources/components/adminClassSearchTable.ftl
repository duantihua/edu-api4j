<table width="100%" onkeypress="dwr.util.onReturn(event, searchClass)">
  ...
  <tr>
   <td class="infoTitle">培养层次:</td>
   <td>
      <select id="class_levelOfMajor" name="adminClass.level.id" style="width:100px;">
 ...
 <script type="text/javascript">
  var classSelect = new Major3Select("class_levelOfMajor","class_department","class_major","class_direction",true,true,true,true);
