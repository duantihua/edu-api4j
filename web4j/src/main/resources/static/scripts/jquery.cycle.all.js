...
$.fn.cycle = function(options, arg2) {
    ...
    // in 1.3+ we can fix mistakers with the ready state
...
$.fn.cycle.defaults = {
	...
	prevNextEvent:'mouseover',// event which drives the manual transition to the previous or next slide
