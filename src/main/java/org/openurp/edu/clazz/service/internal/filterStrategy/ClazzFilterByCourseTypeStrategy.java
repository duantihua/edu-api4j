...
public class ClazzFilterByCourseTypeStrategy extends AbstractClazzFilterStrategy
    implements ClazzFilterStrategy {

  public ClazzFilterByCourseTypeStrategy() {
    super("courseType");
  }

  public String getFilterString() {
    return " where clazz.courseType.id= :id ";
  }
}
