...
public class ProjectContextImpl implements ProjectContext {
  ...
  public User getUser() {
    if (null != ContextCache
        .retreive(prefix + "getUser")) {
      return (User) ContextCache.retreive(prefix + "getUser");
    }
    ...
    ContextCache.cache(prefix + "getUser", users.get(0));
    return users.get(0);
  }

  public Semester getSemester() {
    if (null != ContextCache.retreive(
        prefix + "getSemester")) {
      return (Semester) ContextCache.retreive(prefix + "getSemester");
    }
    Semester r = getSemester_internal();
    ContextCache.cache(prefix + "getSemester", r);
    return r;
  }
  ...
  private String get(String fieldName) {
    String cache = (String) ContextCache.retreive(prefix + fieldName);
    if (cache != null) {
      return cache;
    }
    Profile currentProfile = getCurrentProfile();
    String value = currentProfile.getProperty(fieldName);
    ContextCache.cache(prefix + fieldName, value);
    return value;
  }
  ...
  public Profile getCurrentProfile() {
    Profile cache = (Profile) ContextCache.retreive(prefix + "getCurrentProfile");
    if (cache != null) {
      return cache;
    }
    HttpServletRequest request = getRequest();
    ...
    ContextCache.cache(prefix + "getCurrentProfile", result);
  ...
  private List getAllProjects() {
    List cache = (List) ContextCache.retreive(prefix + ProfileKeys.Project);
    if (cache != null) {
      return cache;
    }
    List<Profile> profiles = profileService.getProfiles(Securities.getUsername(), null);
    ...
    ContextCache.cache(prefix + ProfileKeys.Project, list);
    return list;
  }
