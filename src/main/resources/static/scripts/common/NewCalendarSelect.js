    ...
    function notifyCalendarChange(event){
       ...
       for(var i=0;i<calendarCalendarSelects.length;i++){
	       ...
	       if(null==s) continue;
	       dwr.util.removeAllOptions(calendarCalendarSelects[i].calendarId);
	       if(s.value!=""){
    ...
    function setCalendarOptions(data){
       ...
       if(null!=curCalendarSelect){
	       if(curCalendarSelect.calendarNullable){
	           dwr.util.addOptions(curCalendarSelect.calendarId,[{'id':'','name':'...'}],'id','name');	           
	       }
	       dwr.util.addOptions(curCalendarSelect.calendarId,data,'id','name');
